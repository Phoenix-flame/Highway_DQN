...
if gym.__version__ == '0.21.0':
    env = gym.make('highway-v0', config={'observation': {"type": "Kinematics"}}) ## , config={'lane_change_reward': 0, 'observation': {"type": "TimeToCollision", 'horizon':10}} 
else:
